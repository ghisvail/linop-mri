"""Test suite for the linop_mri.fft module"""
...
from linop_mri.fft import FFTOperator, FFTShiftOperator


class TestFFTOperator(TestCase):
    pass


class TestFFTShiftOperator(TestCase):
    pass
